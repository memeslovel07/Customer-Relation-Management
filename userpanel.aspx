<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userpanel.aspx.cs" Inherits="CRM.userpanel" %>
...
<body>
    <header>  <h1>Customer Relationship Management System</h1>
    <p>Everything you need to get up and running with CRM</p></header>
    <form id="form1" runat="server">
  <nav>
    &nbsp;<asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Complain Registration</asp:LinkButton>
    <a href="View Status.aspx">View Status</a>
      <asp:LinkButton ID="lbtnfeedback" runat="server" OnClick="lbtnfeedback_Click" >Feedback</asp:LinkButton>
    
    <a href="Homepage.aspx">Logout</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
      <asp:Label ID="labwelcom" runat="server" Font-Bold="True" Font-Italic="True"></asp:Label>
